...
def new():
   ...
   canvas= Canvas(root13,width = 800, height = 800,bg="silver" )
   canvas.pack(expand = YES, fill = BOTH)
   root13.title("Joash Parking Registration Form")
   ...
   label_0 = Label(root13, text="JOASH PARKING CONTROL SYSTEM",width=40,font=("", "15", "bold"), foreground="white",bg="brown3")
   ...
   label_9 = Label(root13, text="Business Department",width=20,font=("bold", 10),bg="brown2",fg="white")
   label_9.place(x=80,y=530)

   list3 = ['AGRICULTURE','BIOENGINEERING AND BIOSCIENCES','BUSINESS','ENGINEERING','COMPUTER SALES','FASHION DESIGN','HOTEL MANAGEMENT','FINE ARTS','LAW','PHARMACY'];
   c=StringVar()
...
def request(curr_user):
   ...
   Label(root12,text="Parking Request",bg="#42A5F5",fg="white",font=("Courier", 15)).place(x=200,y=30)
   l1=Label(root12,text="Reg.No:",fg="yellow",bg="#42A5F5").place(x=70,y=80)
   ...
   f=Label(root12,text="Fare(in ksh):",bg="#42A5F5",fg="white").place(x=70,y=190)
   ...
   FareCal=Button(root12,text="Calculate Fare",bg="green",command=calculate_fare).place(x=210,y=190)
   # booking slot button for parking
   park=Button(root12,text="Reserve Parking Slot",bg="purple",command=reserve).place(x=80,y=230)
   root12.mainloop()
...
#-------------------------------------------------------------------------------------------------------------               
labelfont = ('times new roman', 15, 'bold italic')
e4=Label(root,text="Joash Parking Management System",bg="#b2fab4",font=labelfont).place(x=170,y=50)
c1=Canvas(root,relief="raised",border=2,width=400,height=200,bg="#b2fab4").place(x=120,y=100)



l1=Label(c1,text="Registration No.",bg="#b2fab4",font = "Verdana 8 bold ").place(x=190,y=130)
e1=Entry(c1,bd=2,textvariable=regno).place(x=300,y=130)
l2=Label(c1,text="Password",bg="#b2fab4",font = "Verdana 10 bold ").place(x=190,y=160)
bullet="\u2022"
...
b1=Button(c1,text="LOGIN",bg="#FF7F00" ,font="Verdana 8 bold",activebackground="#85929E",command=punch,width=15).place(x=300,y=200)
b2=Button(c1,text="Sign Up",bg="#B5A642",font="Verdana 8 bold",activebackground="#85929E",width=15,command=new).place(x=300,y=250)
root.mainloop()
